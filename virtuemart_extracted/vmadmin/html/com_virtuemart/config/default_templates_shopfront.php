 ...
 * @version $Id: default_templates_shopfront.php 11218 2025-11-03 19:21:40Z Milbo $
 */
...
<div class="uk-card uk-card-small uk-card-vm">
	...
	<div class="uk-card-body">
		<?php
		echo VmuikitHtml::row('booleanlist', 'COM_VIRTUEMART_ADMIN_CFG_XTRATOKENCHKOUT', 'xTokOnCheckout', VmConfig::get('xTokOnCheckout', 1));
		echo VmuikitHtml::row('booleanlist', 'COM_VIRTUEMART_ADMIN_CFG_LEGACYLAYOUTS', 'legacylayouts', VmConfig::get('legacylayouts', 0));
		...
		echo VmuikitHtml::row('booleanlist', 'COM_VIRTUEMART_ADMIN_CFG_SHOW_CATEGORIES', 'show_categories', VmConfig::get('show_categories', 10));
