<?php
/* --------------------------------------------------------------
  ImageRequestController.inc.php 2020-09-04
  Gambio GmbH
  http://www.gambio.de
...
class ImageRequestController extends HttpViewController
{
    public function actionDefault()
    {
        try {
            ...
            $imageDirectoryFixRegex = '#^.*/images/product_images/(attribute_images|gallery_images|info_images|popup_images|properties_combis_images|property_images|thumbnail_images)/#';
