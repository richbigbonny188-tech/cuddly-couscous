<?php
/* --------------------------------------------------------------
   RemovedItemFromGroup.php 2020-05-29
   Gambio GmbH
   http://www.gambio.de
...
class RemovedItemFromGroup
{
    ...
    /**
     * RemovedItemFromGroup constructor.
     *
     ...
     * @param GroupItem $groupItem
     *
     * @return RemovedItemFromGroup
     */
    public static function create(GroupId $groupId, GroupItem $groupItem): RemovedItemFromGroup
    {
