<?php
/* --------------------------------------------------------------
   AssignedRoleToAdmin.php 2020-05-29
   Gambio GmbH
   http://www.gambio.de
...
class AssignedRoleToAdmin
{
    ...
    /**
     * AssignedRoleToAdmin constructor.
     *
     ...
     * @param RoleId  $roleId
     *
     * @return AssignedRoleToAdmin
     */
    public static function create(AdminId $adminId, RoleId $roleId): AssignedRoleToAdmin
    {
