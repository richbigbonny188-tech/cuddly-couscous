<?php
/* --------------------------------------------------------------
   CheckoutPaymentContentView.inc.php 2020-08-05
   Gambio GmbH
   http://www.gambio.de
...
class CheckoutPaymentContentView extends ContentView
{
	...
	{
		$loginPayInitiated = (!empty($_COOKIE['amazon_Login_accessToken']) && $_SESSION['payment'] === 'amazonadvpay');
		$orderReferenceCreated = !empty($_SESSION['amazonadvpay_order_ref_id']);
		
		if($_SESSION['amz_loginpay'] === true || $loginPayInitiated) {
