<?php
/* --------------------------------------------------------------
  PriceOfferContentView.inc.php 2021-02-02
  Gambio GmbH
  http://www.gambio.de
...
class PriceOfferContentView extends ContentView
{
	...
	protected function add_data()
	{
		...
		if(isset($this->content_array['VVCODE_ERROR']) == false && isset($this->content_array['ERROR']) == false && empty($this->v_env_post_array['email']) == false)
		{
			$this->send_mail();
		}
	}
