<?php
/*--------------------------------------------------------------------
 PropertiesCombisAdminControl.inc.php 2021-03-31
 Gambio GmbH
 http://www.gambio.de
        ...
        if (empty($products_properties_combis_id)) {
            $query = 'INSERT INTO `products_properties_combis` 
						SET 
							...
							`products_vpe_id` = ' . (int)$p_data_array['products_vpe_id'] . ',
            ...
            if (isset($p_data_array['products_properties_combis_id'])) {
                $combiId = (int)$p_data_array['products_properties_combis_id'];
                
                // request from property page uses product_image_list_id and from the combination page uses combi_image
                $listId  = (int)($p_data_array['combi_image'] ?? $p_data_array['product_image_list_id']);
