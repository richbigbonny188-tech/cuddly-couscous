<?php
/* --------------------------------------------------------------
  PrintOrderContentView.inc.php 2018-09-05
  http://www.gambio.de
...
class PrintOrderContentView extends ContentView
{
	...
	/**
	 * PrintOrderContentView constructor.
	 */
	...
	protected function add_address_data()
	{
		...
		$this->set_content_data('address_label_customer',
		                        xtc_address_format($this->coo_order->customer['format_id'], $this->coo_order->customer,
		                                           1, '', '<br />'));
		$this->set_content_data('address_label_shipping',
		                        xtc_address_format($this->coo_order->delivery['format_id'], $this->coo_order->delivery,
		                                           1, '', '<br />'));
		$this->set_content_data('address_label_payment',
		                        xtc_address_format($this->coo_order->billing['format_id'], $this->coo_order->billing, 1,
		                                           '', '<br />'));
	}
